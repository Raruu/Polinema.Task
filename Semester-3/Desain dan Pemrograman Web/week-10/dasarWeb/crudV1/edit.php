        ...
        <form action="proses.php?aksi=ubah" method="post">
            ...
            <div class="radio-group">
                ...
                <input type="radio" name="jenis_kelamin" value="p" id="perempuan"
                    <?php if ($row['jenis_kelamin'] === 'P') echo 'checked'; ?> required> <label for="perempuan">Perempuan</label>
            </div>
            ...
            <button class="btn-save" type="submit">Simpan Perubahan</button> <a href="index.php" class="btn-kembali">Kembali</a>
        </form>
    </div>
</body>
