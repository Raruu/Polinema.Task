...
public class SIRAM_PASIEN11 {
    ...
    static void dummy(List<RekamMedik11> rekamMedik11s, List<Dokter11> dokter11s) {
        ...
        for (int i = 0; i < 5; i++) {
            rekamMedik11s.add(new RekamMedik11(1000 + i, new Pasien11(1000 + i, nPas[i], alamatPasien[i], noTelpPasien[i])));
            Dokter11 doketer = new Dokter11(7000+i, namaDokter[i], alamatDokter[i], noTelpDokter[i],spesialisasiDokter[i]);
